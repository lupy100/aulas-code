...
var _notas = __webpack_require__(15);
...
function criarComponentInputTitulo(notaAlterada, posicao) {
  ...
  // = NEW fORMINPUT
  return _react2.default.createElement("formInput", props);
}
...
function criarComponentTextArea(notaAlterada, posicao) {
  ...
  return _react2.default.createElement("formTextarea", props);
}
...
function FormNotas(_ref) {
  ...
  var notaAlterada = new _notas2.default(props.notaAtual.titulo, props.notaAtual.texto, props.notaAtual.editando);
  var inputTitulo = criarComponentInputTitulo(notaAlterada, posicao);
  var textArea = criarComponentTextArea(notaAlterada, posicao);

  var props = { className: "nota" };
...
var _secao = __webpack_require__(30);

var _secao2 = _interopRequireDefault(_secao);

var _formNotas = __webpack_require__(14);
...
var _listaNota = __webpack_require__(36);
...
function montaFormNotas(listaNotas, adicionarNota, removerNota, editarFormulario) {
  ...
  return _react2.default.createElement(formNotas, props);
}

function montaSectionNotas(listaNotas, adicionarNota, removerNota, editarFormulario) {
  var props = {
    key: "section-notas",
    listaNotas: new _listaNota2.default("", ""),
    adicionarNota: adicionarNota,
    removerNota: removerNota,
    editarFormulario: editarFormulario
  };

  return _react2.default.createElement(_secao2.default, props);
}

var listaNotas = new _listaNota2.default();
...
var Main = function (_React$Component) {
  ...
  function Main(props) {
    ...
    _this.atualizarPagina = _this.atualizarPagina.bind(_this);
    // this.atualizarPagina = this.atualizarPagina.bind(this);
    _this.state = {
      listaNotas: new _listaNota2.default(_this.atualizarPagina)
    };
    return _this;
  }
  ...
  _createClass(Main, [{
    ...
    key: "removerNota",
    value: function removerNota(posicao, event) {
      event.stopPropagation();
    ...
    key: "atualizarPagina",
    value: function atualizarPagina(newList) {
      console.log("what hell is this?", this);
      this.setState({
        listaNotas: new _listaNota2.default(this.atualizarPagina)
      });
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var children = [_formNotas2.default, SecaoNotas];
      var SecaoNotas = montaSectionNotas(this.state.listaNotas, this.adicionarNota, this.removerNota, this.editarFormulario);

      return _react2.default.createElement("main", props);
    }
  }]);
...
function criaFormNotas(posicao, listaNota, adicionarNota, removerNota, editarFormularios) {
  var propsFormNotas = {
    key: posicao,
    posicao: posicao,
  ...
  var form = _react2.default.createElement(formNotas, propsFormNotas);

  return _react2.default.createElement(_formNotas2.default, props);
}

function SecaoNotas(_ref) {
  var listaNota = _ref.listaNota,
      removerNota = _ref.removerNota,
      adicionarNota = _ref.adicionarNota;
  ...
  for (var _posicao = 0; _posicao < listaNota.contaTotal(); _posicao++) {
    var formNota = criaFormNotas(_posicao, props);
    children.push(_formNotas2.default);
  }

  return _react2.default.createElement(
    _section2.default,
    props,
    listaNota.pegaTodos().map(function (notaAtual, indice) {
      return criaFormNotas(posicao, listaNota, adicionarNota, removerNota, editarFormularios);
    })
  );
}
